...
namespace My_Weather.DailyWeather
{
    ...
    public class Moon
    {
        ...
        public object EpochRise { get; set; }
        public DateTime Set { get; set; }
        public int EpochSet { get; set; }
    ...
    public class Night
    {
        ...
        public Evapotranspiration1 Evapotranspiration { get; set; }
        public Solarirradiance1 SolarIrradiance { get; set; }
    }
    ...
    public class Evapotranspiration1
    {
        public float Value { get; set; }
        public string Unit { get; set; }
        public int UnitType { get; set; }
